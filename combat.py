...
def calc_combat(player: dict, enemy: dict, attack_type: str) -> dict:
    ...
    try:
        ...
        _pulse_crit = 0
    dmg_mult    = atk["dmg_mult"] + skb["dmg_pct"] + setb.get("dmg_pct", 0) + rb["dmg_pct"] + guild_dmg_pct + fate_dmg_pct + class_dmg_mult_add
...
def get_combat_stats_summary(player: dict) -> dict:
    ...
    total_dmg_pct    = (atk["dmg_mult"] - 1.0) + skb.get("dmg_pct", 0) + setb.get("dmg_pct", 0) + rb.get("dmg_pct", 0) + guild_dmg_pct + fate_dmg_pct + class_dmg_mult_add
