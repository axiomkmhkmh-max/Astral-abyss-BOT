...
from gap_king_handlers import register_gap_king_handlers
from gap_city_market_handlers import register_gap_city_market_handlers
from gap_daily_wheel_handlers import register_gap_daily_wheel_handlers
...
async def run_gap_side():
    ...
    register_gap_king_handlers(dp)
    register_gap_city_market_handlers(dp)
    register_gap_daily_wheel_handlers(dp)
