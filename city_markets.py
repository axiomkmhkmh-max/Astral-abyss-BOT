...
#
#  فقط از رویِ economy.MAPS_DATA، item_system (تولیدِ آیتم/مصرفی) و
#  database.city_market_col می‌خونه/می‌نویسه. هیچ فایلِ قدیمیِ دیگه‌ای
#  رو تغییر نمی‌ده و هیچ فیلدِ موجودِ پلیر رو دستکاری نمی‌کنه.
# ============================================================
