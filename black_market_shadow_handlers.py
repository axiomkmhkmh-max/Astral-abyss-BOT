...
async def cb_bm_auction_buy(cb: CallbackQuery):
    ...
    # 🔒 باگ‌فیکس: قبلاً بدونِ player_lock بود — همون کلاسِ باگِ دابل‌تپ که
    # تو خریدِ تخمِ پت و بقیه‌ی دلال‌های بازارِ سیاه بود.
    ...
    await bridge.economy_ledger.record_transaction(
