...
CATEGORIES: dict[str, dict] = {
    ...
    "تاجر": {
        ...
        "buttons": ["🚶 سفر", "🤝 معامله‌ی روزانه", "مغازه‌ی من", "بازار سیاه", "🦯 عصا", "⚜️ قدرت‌های کلاس"],
    },
    "درمانگر": {
        "title": "✨ *درمانگر*",
        "class_only": CLASS_HEALER,
        "buttons": ["بیمارستان", "🩺 نوبت‌دهی", "💊 درمان", "💍 انگشتر", "⚜️ قدرت‌های کلاس"],
    },
    "جادوگر": {
        "title": "🧙 *جادوگر*",
        "class_only": CLASS_WIZARD,
        "buttons": ["🛠 کارگاه", "🔮 مشتری‌ها", "🪄 چوب‌دستی", "⚜️ قدرت‌های کلاس"],
    },
    "گیلد": {
        "title": "🏰 *گیلد*",
        "class_only": None,
