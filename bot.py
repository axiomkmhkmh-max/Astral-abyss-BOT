...
CATEGORIES: dict[str, dict] = {
    ...
    "من": {
        "title": "📊 *شخصیتِ من*",
        "class_only": None,
        "buttons": ["وضعیت", "کوله‌پشتی", "🎽 تجهیزات", "🎴 کارت من", "📖 کدکس", "مهارت‌ها", "🌌 صورت‌فلکی", "دستاوردها", "تیر جهان", "🔗 اتصال حساب"],
    },
    "اجتماعی": {
        "title": "🏛 *اجتماعی*",
        "class_only": None,
...
LEVEL_REQUIREMENTS: dict[str, int] = {
    ...
    "گیلدها": 10,
    "وضعیت": 1, "کوله‌پشتی": 1, "🎽 تجهیزات": 1, "🎴 کارت من": 1, "📖 کدکس": 1, "مهارت‌ها": 1, "🌌 صورت‌فلکی": 1, "دستاوردها": 1, "تیر جهان": 1, "🔗 اتصال حساب": 1,
